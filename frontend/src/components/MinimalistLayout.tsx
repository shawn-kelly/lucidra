        ...
        <DrawerContent>
          ...
          <DrawerBody p={6}>
            <VStack spacing={6} align="stretch">
              <Text fontSize="xl" fontWeight="bold">🤖 AI Guide Settings</Text>
              
              <FormControl>
                <FormLabel>Enable AI Guide</FormLabel>
                <Switch
                  isChecked={aiGuideSettings.enabled}
                  onChange={(e) => setAiGuideSettings(prev => ({ ...prev, enabled: e.target.checked }))}
                  colorScheme="green"
              ...
              <FormControl>
                ...
                <Select
                  value={aiGuideSettings.voice}
                  onChange={(e) => setAiGuideSettings(prev => ({ ...prev, voice: e.target.value as 'male' | 'female' }))}
                >
              ...
              <FormControl>
                ...
                <Select
                  value={aiGuideSettings.accent}
                  onChange={(e) => setAiGuideSettings(prev => ({ ...prev, accent: e.target.value as any }))}
                >
              ...
              <FormControl>
                <FormLabel>Speech Speed: {aiGuideSettings.speed.toFixed(1)}x</FormLabel>
                <input
                  type="range"
                  min="0.5"
                  max="2.0"
                  step="0.1"
                  value={aiGuideSettings.speed}
                  onChange={(e) => setAiGuideSettings(prev => ({ ...prev, speed: parseFloat(e.target.value) }))}
                  style={{ width: '100%' }}
                />
              </FormControl>
              
              <FormControl>
                <FormLabel>Volume: {Math.round(aiGuideSettings.volume * 100)}%</FormLabel>
                <input
                  type="range"
                  min="0"
                  max="1"
                  step="0.1"
                  value={aiGuideSettings.volume}
                  onChange={(e) => setAiGuideSettings(prev => ({ ...prev, volume: parseFloat(e.target.value) }))}
                  style={{ width: '100%' }}
                />
              </FormControl>
              
              <FormControl>
                <FormLabel>Proactive Help</FormLabel>
                <Switch
                  isChecked={aiGuideSettings.proactiveHelp}
                  onChange={(e) => setAiGuideSettings(prev => ({ ...prev, proactiveHelp: e.target.checked }))}
                  colorScheme="blue"
                />
              </FormControl>
              ...
              <Button
                colorScheme="blue"
                onClick={() => playAIGuide("Hello! This is a test of your AI guide settings. I can help you navigate through the platform and provide contextual assistance.")}
                disabled={!aiGuideSettings.enabled}
              >
                Test AI Voice
              </Button>
            </VStack>
