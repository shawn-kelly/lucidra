...
const ProcessManagement: React.FC = () => {
  ...
  // BPMN Designer Component with full functionality
  const BPMNDesigner = () => (
    <VStack spacing={6} align="stretch">
      <HStack justify="space-between">
              ...
              >
                ...
                {selectedProcess.steps.length === 0 && (
                  <VStack spacing={4} justify="center" align="center" h="full">
                    ...
                    <Text fontSize="lg" fontWeight="bold">Design Your Process</Text>
                    <Text color="gray.500" textAlign="center">
                      Add swimlanes and steps to create your BPMN process flow
                    </Text>
                    <Button colorScheme="blue" leftIcon={<AddIcon />} onClick={onStepDetailOpen}>
                      Add First Step
                    </Button>
          ...
          <Card bg={cardBg}>
            ...
            <CardBody>
              <VStack spacing={4} align="stretch">
                {/* Step Types */}
                <Box>
                  <Text fontSize="sm" fontWeight="semibold" mb={2}>Step Types</Text>
                  <SimpleGrid columns={2} spacing={2}>
                    <Button size="sm" leftIcon={<CheckIcon />} colorScheme="green" variant="outline">
                      Start
                    </Button>
                    <Button size="sm" leftIcon={<InfoIcon />} colorScheme="blue" variant="outline">
                      Task
                    </Button>
                    <Button size="sm" leftIcon={<WarningIcon />} colorScheme="orange" variant="outline">
                      Decision
                    </Button>
                    <Button size="sm" leftIcon={<CloseIcon />} colorScheme="red" variant="outline">
                      End
                    </Button>
                  </SimpleGrid>
                </Box>
