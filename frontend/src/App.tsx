...
import HRManagementNew from './components/HRManagementNew';
import BlueOceanStrategy from './components/BlueOceanStrategy';
import ProcessImprovementIntelligence from './components/ProcessImprovementIntelligence';
import ProcessManagement from './components/ProcessManagement';
import ProjectManagement from './components/ProjectManagement';
import MinimalistLayout from './components/MinimalistLayout';
import ABCCosting from './components/ABCCosting';
...
import StrategyFrameworksPage from './pages/StrategyFrameworksPage';
...
function App() {
  ...
  const renderCurrentView = () => {
    switch (currentView) {
      case 'home':
        return <McKinseyDashboard onNavigate={setCurrentView} />;
